...
const WashingtonDC = () => {
  ...
  if (!data)
    return <p className="text-center mt-8 text-red-500">No data found.</p>
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white shadow-md rounded-xl p-4 max-w-lg mx-auto">
        ...
        <p>
          <strong>Average Salary:</strong> ${data.salary}
        </p>
        <p>
          <strong>Affordability Index:</strong> {data.affordability.toFixed(2)}
        </p>
        <h3 className="font-semibold mt-4">Cost of Living:</h3>
        <ul className="list-disc ml-6">
          <li>
            Monthly Net Salary: ${data.costOfLiving.avg_monthly_net_salary}
          </li>
